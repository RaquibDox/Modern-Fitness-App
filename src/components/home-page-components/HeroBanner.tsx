...
const HeroBanner = () => {
  return (
  <>
    <img src='./assets/images/web-banner-img1.png' alt='banner' className="hidden w-full bg-cover tablet:block"/>
    <img src='./assets/images/Web-Banner-Img1.jpg' alt='banner' className="block w-full bg-cover tablet:hidden"/>
